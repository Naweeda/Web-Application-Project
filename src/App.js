      ...
      <div className="outer">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><Link to="/sign-up" className="link">Register</Link></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#"><Link id="login-link" to="/sign-in" className="link">Login</Link></a>
                    </li>
                    </ul>
                </div>
            </nav>
